...
function handleImageError() {
    ...
    document.getElementById('docs-card').style.gridRow = 'span 1';
    document.getElementById('docs-card-content').style.flexDirection = 'row';
...
main {
    ...
    .card {
        ...
        box-shadow: 0px 14px 24px 0px rgba(0, 0, 0, 0.08), 0 0 0 1px var(--ring-color);
        ...
        .card-icon {
            ...
            border-radius: 50%;
            background-color: rgba(#ff2d20, 0.1);
    ...
    #docs-card {
        ...
        .screenshot-container {
            ...
            .overlay {
                ...
                background-image: linear-gradient(to bottom, transparent, #ffffff 50%);
            }
        }
    ...
    main {
        ...
        #docs-card {
            .screenshot-container {
                ...
                .overlay {
                    background-image: linear-gradient(to bottom, transparent, #18181b 50%);
                }
            }

            .docs-card-wrapper #docs-card-content {
                flex-direction: column;
            }
        }
    }
